...
- **Manual**: the pasted cookie header is forwarded as-is, so cost and status share the same session.
...
- Pages of 1000 events (up to 200 pages), deduplicated across pages before aggregation.
